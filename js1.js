...
const popupHTML = `
    <div class="popup-overlay" id="popup" style="display: none;position: fixed;top: 0; left: 0;width: 100%; height: 100%;background: rgba(0, 0, 0, 0.5);justify-content: center;align-items: center;z-index: 9999;">
        <div class="popup-box" style="background: #fff;padding: 20px 30px;border-radius: 10px;text-align: center;box-shadow: 0 0 20px rgba(0,0,0,0.2);max-width: 300px;">
            ...
            <button style="background: green; color: white;   border: none;   width: 125px;   cursor: pointer;   font-size: 2rem;   padding: 5px 0;   border-radius: 25px;" background: green;" onclick="redirectToTest()">Yes</button>
            <button style="background: crimson; color: white;   border: none;   width: 125px;   cursor: pointer;   font-size: 2rem;   padding: 5px 0;   border-radius: 25px;" background: crimson;" onclick="closePopup()">No</button>
        </div>
    </div>
`;
